...
project = 'RNAja'
copyright = '2021-2022, A Comte (IRD)'
github_doc_root = 'https://github.com/Aucomte/RNAja/tree/main/docs/'
issues_github_path = 'https://github.com/Aucomte/RNAja/issues'
...
html_short_title = "RNAja"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = '_images/RNAja_logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_images/RNAja_logo.png'
